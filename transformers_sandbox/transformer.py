...
__all__ = ['LMMixin', 'EncDecMixin', 'TransformerEncoderBlock', 'Identity', 'TransformerEncoder',
           'TransformerDecoderBlock', 'TransformerDecoderBlockV2', 'TransformerDecoder', 'TransformerLM',
           'transformer_lm_splits', 'Transformer', 'transformer_splits', 'LowMemEncoderBlock', 'LowMemEncoder',
...
class TransformerEncoder(Module):
    ...
    def __init__(self,
        ...
        self.in_proj = Identity() if d_emb==d_model else nn.Linear(d_emb, d_model)
...
class TransformerLM(Module, LMMixin):
    ...
    Parameters:
        ...
        * d_emb: int - embedding dimention, if None defaults to d_model
    ...
    def __init__(self,
        ...
        store_attr()
        d_emb = ifnone(d_emb, d_model)
        self.emb = TransformerEmbedding(vocab_sz, d_emb, max_seq_len, dropout=emb_dropout,
        ...
        self.encoder = TransformerEncoder(d_model, n_layers, n_heads, causal=causal, d_ff=d_ff,
                                          d_emb=d_emb, attn_dropout=attn_dropout, ff_dropout=ff_dropout,
