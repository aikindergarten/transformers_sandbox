...
__all__ = ['Scale', 'Shift', 'Residual', 'PostNorm', 'PreNorm', 'ReZero', 'FeedForward', 'get_axial_shape',
           'get_axial_dims', 'AbsolutePositionalEmbedding', 'FixedPositionalEmbedding', 'TransformerEmbedding']
...
class ReZero(Module):
    ...
    Output of residual branch is multiplied by scalar parameter
    initialized as 0 by default"""
    def __init__(self, sublayer:Module, scale=0.):
        self.sublayer = sublayer
        self.scale = Scale(scale)
    def forward(self, x, *args, **kwargs):
        return x + self.scale(self.sublayer(x, *args, **kwargs))
